...
interface Props {
  onSelectJourney: (type: 'custom' | 'program', program?: PurchasedProgram) => void;
...
export const JourneySelectionScreen: React.FC<Props> = ({ 
  ...
  const renderCustomJourneyCard = () => (
    <Animated.View entering={FadeIn.delay(300).duration(600)}>
      <HapticButton
        hapticType="medium"
        onPress={() => onSelectJourney('custom')}
      ...
      >
        ...
        <View style={styles.customJourneyContent}>
          ...
          <View style={styles.customJourneyText}>
            <Text style={styles.customJourneyTitle}>Create Your Journey</Text>
            <Text style={styles.customJourneySubtitle}>
              Design a personalized path to your goals
            </Text>
          </View>
